...
# --- CMSIS-NN Library 추가 ---
IPATH += CMSIS-NN/Include/
VPATH += CMSIS-NN/Source/ConvolutionFunctions/
VPATH += CMSIS-NN/Source/NNSupportFunctions/
VPATH += CMSIS-NN/Source/PoolingFunctions/
VPATH += CMSIS-NN/Source/FullyConnectedFunctions/
VPATH += CMSIS-NN/Source/BasicMathFunctions/
VPATH += CMSIS-NN/Source/ActivationFunctions/

SRCS += mcu_inference.c
SRCS += softmax.c

RESNET_DEPTH ?= 0
PROJ_CFLAGS += -DRESNET_DEPTH=$(RESNET_DEPTH)